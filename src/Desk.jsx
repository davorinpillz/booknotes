...
export default function Desk() {
  ...
  function addToCollection() {
    axios.post('https://booknotes-db:10000/create', {
  ...
  function getCollection() {
    axios.get('https://booknotes-db:10000/all')
    .then(function(response) {
...
function BookNotes ( { book } ) {
  ...
  function addNoteToBook() {
    axios.post(`https://booknotes-db:10000/:${book.isbn}/addnote`, {
      book_id: book.isbn,
      note: inputNote,
    })
    .then(function(response) {
  ...
  function addChapterTitle(n) {
    axios.put(`https://booknotes-db:10000/addtitle`, {
      title: title,
      noteId: n.note_id,
    })
    .then(function(response) {
  ...
  function addPageNumber(n) {
    axios.put(`https://booknotes-db:10000/addpagenumber`, {
  ...
  function addComment(n) {
    axios.post(`https://booknotes-db:10000/addcomment`, {
      comment: comment,
      noteId: n.note_id,
      bookId: n.book_id,
  ...
  function addCrossReference() {
    if (reference.length == 2) {
      axios.post(`https://booknotes-db:10000/crossreference`, {
  ...
  function getNotesForBook() {
    axios.get(`https://booknotes-db:10000/${book.isbn}/notes`)
    .then(function(response) {
  ...
  function getCommentsForBook() {
    axios.get(`https://booknotes-db:10000/${book.isbn}/bookcomments`)
    .then(function(response) {
  ...
  function getNoteReferencesForBook() {
    axios.get(`https://booknotes-db:10000/${book.isbn}/noterefs`)
    .then(function(response) {
...
function Note ( { 
  ...
  function getSingleRef(id) {
    console.log(id)
    axios.get(`https://booknotes-db:10000/singleref`, {
      params: {
        noteId: [id]
      },
  ...
  function getNoteRef(ids) {
    console.log(ids)
    axios.get(`https://booknotes-db:10000/noteref`, {
      params: {
        noteId: [ids]
      },
      paramsSerializer: function (params) {
